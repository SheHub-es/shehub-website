...
export const mentorsTranslations: TranslationObject = {
  // Hero
  'mentors.hero.eyebrow': {
    es: 'Únete a SheHub como mentora',
    en: 'Join SheHub as a mentor',
    ca: 'Uneix-te a SheHub com a mentora',
  },
  'mentors.hero.title.before': {
    es: 'Apoya a la próxima generación en tecnología y',
    en: 'Support the next generation in tech and',
    ca: 'Dona suport a la propera generació en tecnologia i',
  },
  'mentors.hero.title.highlight': {
    es: 'crece como líder',
    en: 'grow as a leader',
    ca: 'creix com a líder',
  },
  ...
  'mentors.hero.image.alt': {
    es: 'Mentoras de SheHub colaborando',
    en: 'SheHub mentors collaborating',
    ca: 'Mentores de SheHub col·laborant',
  },

  // Why Mentor
  'mentors.why.title.before': {
    es: '¿Por qué convertirte en',
    en: 'Why become a',
    ca: 'Per què convertir-te en',
  },
  'mentors.why.title.highlight': {
    es: 'mentora',
    en: 'mentor',
    ca: 'mentora',
  },
  'mentors.why.title.after': {
    es: 'en SheHub?',
    en: 'at SheHub?',
    ca: 'a SheHub?',
  },
  ...
  'mentors.why.feature3.title': {
    es: 'Flexible y asíncrono',
    en: 'Flexible & async',
    ca: 'Flexible i asíncron',
  },
  ...
  // How It Works
  'mentors.howItWorks.eyebrow': {
    es: 'Cómo funciona SheHub',
    en: 'How SheHub works',
    ca: 'Com funciona SheHub',
  },
  'mentors.howItWorks.title.before': {
    es: 'Tu camino como mentora',
    en: 'Your journey as a mentor',
    ca: 'El teu camí com a mentora',
  },
  'mentors.howItWorks.title.highlight': {
    es: 'en solo 4 pasos',
    en: 'in just 4 steps',
  ...
  // Timeline
  'mentors.timeline.step1.date': {
    es: 'Día 1',
    en: 'Day 1',
    ca: 'Dia 1',
  },
  'mentors.timeline.step1.title': {
    es: 'Aplica',
    en: 'Apply',
    ca: 'Aplica',
  },
  ...
  'mentors.timeline.step2.title': {
    es: 'Encuentra tu equipo',
    en: 'Get matched',
    ca: 'Troba el teu equip',
  },
  'mentors.timeline.step2.description': {
    es: 'Te asignaremos a un equipo o una oportunidad de mentoría que se ajuste a tus habilidades, intereses y nivel de implicación deseado (Mentora o Líder de Equipo).',
    en: "We'll match you with a team or mentoring opportunity that aligns with your skills, interests, and desired level of involvement (Mentor or Team Lead).",
    ca: "T'assignarem a un equip o una oportunitat de mentoria que s'ajusti a les teves habilitats, interessos i nivell d'implicació desitjat (Mentora o Líder d'Equip).",
  },
  'mentors.timeline.step3.date': {
    es: 'Día X',
    en: 'Day X',
    ca: 'Dia X',
  },
  'mentors.timeline.step3.title': {
    es: 'Únete al espacio de mentoras',
    en: 'Join the mentor space',
    ca: "Uneix-te a l'espai de mentores",
  },
  ...
  'mentors.testimonials.item1.role': {
    es: 'Senior Product Manager',
    en: 'Senior Product Manager',
    ca: 'Senior Product Manager',
  },
  'mentors.testimonials.item1.alt': {
    es: 'Avatar de una mentora, senior product manager',
    en: 'Avatar of a female mentor, senior product manager',
    ca: "Avatar d'una mentora, senior product manager",
  },
  'mentors.testimonials.item2.name': {
  ...
  'mentors.testimonials.item2.alt': {
    es: 'Avatar de una mentora, project manager',
    en: 'Avatar of female mentor, project manager',
    ca: "Avatar d'una mentora, project manager",
  },
  ...
  'mentors.faq.item1.header': {
    es: '¿Necesito ser senior o líder de equipo para ser mentora?',
    en: 'Do I need to be a senior or team lead to mentor?',
    ca: "Necessito ser senior o líder d'equip per ser mentora?",
  },
  'mentors.faq.item1.text': {
    es: 'Para nada. Si tienes 2 o más años de experiencia en tu área tecnológica y quieres apoyar a otras personas, ya estás lista para ser mentora en SheHub.',
    en: "Not at all. If you have 2+ years of experience in your tech role and want to support others, you're ready to mentor at SheHub.",
    ca: "Per a res. Si tens 2 o més anys d'experiència en la teva àrea tecnològica i vols donar suport a altres persones, ja estàs preparada per ser mentora a SheHub.",
  },
  'mentors.faq.item2.header': {
  ...
  'mentors.faq.item3.header': {
    es: '¿Puedo elegir cómo contribuir?',
    en: 'Can I choose how to contribute?',
    ca: 'Puc triar com contribuir?',
  },
  'mentors.faq.item3.text': {
    es: 'Sí. Puedes optar por ser una mentora estándar para un equipo, o una líder vertical apoyando a varios equipos con una visión estratégica. La decisión es tuya.',
    en: "Yes. You can opt to be a standard mentor for one team, or a vertical lead supporting multiple teams with a strategic lens. It's your call.",
    ca: 'Sí. Pots optar per ser una mentora estàndard per a un equip, o una líder vertical donant suport a diversos equips amb una visió estratègica. La decisió és teva.',
  },
  'mentors.faq.item4.header': {
    es: '¿La mentoría en SheHub es remunerada?',
    en: 'Is mentoring at SheHub paid?',
    ca: 'La mentoria a SheHub és remunerada?',
  },
  ...
  'mentors.cta.button': {
    es: 'Únete como mentora',
    en: 'Join as a mentor',
    ca: 'Uneix-te com a mentora',
  },
};
