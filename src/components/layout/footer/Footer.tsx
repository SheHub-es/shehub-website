        ...
        <div className="font-secondary">
          <div className="flex flex-col items-center justify-between gap-y-4 lg:flex-row lg:gap-y-0 mb-0">
            ...
            <div className="flex shrink-0 items-center gap-2 p-2.5">
              ...
              >
                <Icon 
                  icon={<AthenaIconMail width={24} height={24} />} 
                  className="text-[var(--color-icon-default)] group-hover:text-[var(--color-icon-hover)]" 
                />
              ...
              >
                <Icon 
                  icon={<AthenaIconInstagram width={24} height={24} />} 
                  className="text-[var(--color-icon-default)] group-hover:text-[var(--color-icon-hover)]" 
                />
              </a>
              ...
              >
                <Icon 
                  icon={<AthenaIconLinkedin width={24} height={24} />} 
                  className="text-[var(--color-icon-default)] group-hover:text-[var(--color-icon-hover)]" 
                />
              </a>
            </div>
