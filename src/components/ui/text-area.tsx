...
export const TextArea: React.FC<TextAreaProps> = ({
    ...
    return (
        <div className="flex-col gap-1 inline-flex items-start">
            ...
            <textarea className="w-[584px] h-[157px] flex p-3 items-start self-stretch rounded-[12px] border-2 border-gray-300 bg-white gap-2.5 placeholder:text-size-400 placeholder:font-default placeholder:leading-line-height-body-2 text-gray-500 placeholder:text-gray-500 hover:border-purple-600 disabled:bg-disabled placeholder:disabled:text-gray-600 disabled:cursor-not-allowed" placeholder={placeholder} disabled={disabled}/>
            {helperText && (
