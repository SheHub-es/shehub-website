...
import HeroText from '@/sections/HeroSection/elements/TypewriterAnimation'
  ...
  return (
    <div className="flex flex-col h-[638px]">
        <div className='gap-[48px] flex flex-col'>
            ...
            <div className="font-[var(--font-weight-heavy)] text-[length:var(--text-size-1000)] leading-[var(--spacing-line-height-heading-1)] flex flex-col">
        ...
        <div className='mt-[30px]'>
            <div className="flex gap-[16px]">
                ...
                <Button 
                    ...
                    size="sm" 
                    shape="rounded" 
                    className="min-w-[188px] min-h-[48px]"
                    style={{ fontFamily: 'var(--font-secondary)' }}
                >
                    Mentor a team
                </Button>
