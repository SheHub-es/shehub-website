...
import ImageSection from '@/sections/collaboratorsMentors/components/ImageSection'
import TextSection from '@/sections/collaboratorsMentors/components/TextSection'
