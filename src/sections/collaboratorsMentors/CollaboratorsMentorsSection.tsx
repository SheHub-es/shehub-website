...
import ImageSection from '@/sections/collaboratorsMentors/elements/ImageSection'
import TextSection from '@/sections/collaboratorsMentors/elements/TextSection'
